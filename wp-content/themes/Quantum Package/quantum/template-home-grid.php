...
if(isset($_REQUEST["um_load_more"]) && $_REQUEST["um_load_more"]):
    ...
    while ( $the_query->have_posts() ) :  $the_query->the_post();
        ...
        ?>
        <div class="project_con_g col-sm-3 col-xs-6 animated">
        ...
        while ( $the_query->have_posts() ) :  $the_query->the_post();
            ...
            <div class="project_con_g col-sm-3 col-xs-6 animated">
                <div class="post_thumb_g">
                    ...
                    <?php if($img): ?>
                        <a href="<?php the_permalink(); ?>"> <img src="<?php echo aq_resize($img,255,184,true); ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id($post->ID) , '_wp_attachment_image_alt', true); ?>"/></a>
                    <?php endif; ?>
                </div>
                <div class="post_title_g g2">
                    <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
