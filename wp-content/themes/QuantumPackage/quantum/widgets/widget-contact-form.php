...
class umbrella_contact_form extends WP_Widget{
    ...
    function widget($args, $instance)
    {
        ...
        ?>
        <div class="um-contact-widget" >
            <div class="widget_title"><h5><?php echo $title; ?></h5></div>
            <form action="" class="contact-widget" data-contact_form_id="<?php echo $contact_form_id; ?>">
                ...
                <p><input class="button_u" type="submit" name="w-send" id="w-send" value="<?php _e("Send","um_lang"); ?>"></p>
            </form>
