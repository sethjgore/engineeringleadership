...
?>
    ...
    <div class="grid_4_team row">
        ...
        ?>
            <div class="team_con_g col-sm-4 animated fadeIn">
                <div class="post_thumb_g">
                            ...
                            <div class="hover_social">
                                ...
                                <?php
                                    ...
                                    if($social):
                                        foreach($social as $r):
                                ?>
                                    <li><a target="_blank" href="<?php echo $r["social_network_url"]; ?>"><i class="fa <?php echo $r["social_network"]; ?>"></i></a></li>
                                <?php
                                        endforeach;
                                    endif;
                                ?>
                    ...
                    <?php if($member["image"]): ?>
                        <img src="<?php echo aq_resize($member["image"],360,265,true); ?>" alt="<?php echo get_post_meta(um_get_id_from_src($member["image"]) , '_wp_attachment_image_alt', true); ?>"/>
                    <?php endif; ?>
                </div>
                <div class="team_desc">
