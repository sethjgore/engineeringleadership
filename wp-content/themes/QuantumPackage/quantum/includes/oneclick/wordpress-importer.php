 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
class Um_WP_Import extends WP_Importer {
	...
	function import_end() {
		...
		echo "Congratulations, all data backed up and the theme now is same as the demo one.";
...
<?php
	...
	function process_attachment( $post, $url ) {
        ...
        $url = get_template_directory()."/includes/oneclick/demo.jpg";
