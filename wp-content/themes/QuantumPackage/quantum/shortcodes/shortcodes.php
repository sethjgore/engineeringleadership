...
add_shortcode("dropcap","umbrella_dropcap1_shortcode");
...
/*ET Icon*/
function umbrella_et_icon_shortcode($atts,$content){
    extract(shortcode_atts( array('icon'=>'','fontsize'=>''), $atts));
    return "<span aria-hidden='true' style='font-size:{$fontsize}px' class='{$icon}'></span>";
}
add_shortcode("eticon","umbrella_et_icon_shortcode");
/*ET Icon*/
...
function register_button( $buttons ) {
    ...
    array_push( $buttons, "separator", "dropcap_btn" );
    ...
    array_push( $buttons, "separator", "eticon_btn" );
    return $buttons;
}
...
function add_plugin( $plugin_array ) {
    ...
    $plugin_array['dropcap_btn'] = get_template_directory_uri() . '/shortcodes/tiny_mce_buttons.js';
    ...
    $plugin_array['eticon_btn'] = get_template_directory_uri() . '/shortcodes/tiny_mce_buttons.js';
    return $plugin_array;
}
/*Generics*/
