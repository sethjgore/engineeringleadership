...
/*Template Name:Home Grid 3 Columns*/
get_header();
?>
        ...
        while ( $the_query->have_posts() ) :  $the_query->the_post();
            ...
            <div class="project_con_g col-sm-4 col-xs-12 animated">
                <div class="post_thumb_g">
                    ...
                    <?php if($img): ?>
                        <a href="<?php the_permalink(); ?>"> <img src="<?php echo aq_resize($img,350,253,true); ?>" alt="<?php echo get_post_meta(get_post_thumbnail_id($post->ID) , '_wp_attachment_image_alt', true); ?>"/></a>
                    <?php endif; ?>
                </div>
                <div class="post_title_g g2">
                    <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
